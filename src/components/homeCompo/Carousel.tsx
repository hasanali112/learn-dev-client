...
const Carousel = () => {
  ...
  const imageSlide = [
    ...
    {
      url: "https://images.unsplash.com/photo-1515704089429-fd06e6668458?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      url: "https://images.unsplash.com/photo-1588053631229-d04fd47cf0ad?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
  ...
  return (
    <div className="lg:w-[79%] md:w-4/5 mx-auto mt-5 lg:mt-10  group  relative p-3 md:p-0 lg:p-0">
      <div
        id="image-clip"
        style={{
